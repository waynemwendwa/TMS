            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-yellow-800">
                  Approval Workflow Temporarily Unavailable
                </h3>
                <div className="mt-2 text-sm text-yellow-700">
                  <p>The approval workflow feature is currently being set up. Database migration is required to enable full functionality.</p>
                </div>
              </div>
            </div>
          </div>
